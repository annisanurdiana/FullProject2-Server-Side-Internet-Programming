...
<head>
    ...
    <title>Matrix 2x2</title>
</head>
<body style="background:url('../img/bubble wave.gif'); background-size:cover; color:white">
    <div class="calculate" style="padding-left: 25%; padding-top:5%;padding-bottom:5%;">

    <form action="" method="post">
        <table>
            <tr><h2><b>Matrix 1</b></h2></tr>
            <tr>
                <td>Enter [ 0 , 0 ]: </td>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <br><input style="background-color:blueviolet; color:white;" type="submit" name="pop" value="Calculate" id="calc">
                </td>
            </tr>
        </table>
    </form>
